...
We report the survey answers from these two groups in "Fig: Density of Survey Answers". One can tell that in both groups, most people have an answer value close to the true value. However, the "small multiple lines" group seems to have higher accuracy by this preliminary result, which shows our 1st hypothesis is right.
...
## Appendix
```{r sourcedata, include=FALSE}
# We got our source data for graphs from IPUMS.
